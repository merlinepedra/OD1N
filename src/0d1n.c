...
LAST
"0d1n --host 'http://site.com/view/1^/product/^/' --payloads /opt/0d1n/payloads/sqli_list.txt --find_string_list /opt/0d1n/payloads/sqli_str2find_list.txt --log log1337 --tamper randcase --threads 5 --timeout 3 --save_response\n"
"\n"
YELLOW
 "example 2 to Bruteforce in simple auth:\n"
LAST
"0d1n --host 'http://site.com/auth.py' --post 'user=admin&password=^' --payloads /opt/0d1n/payloads/wordlist.txt --log log007 --threads 10 --timeout 3\n"
"\n"
YELLOW
...
"example 4 Brute dir:\n"
LAST
"0d1n --host https://page/^ --payloads /opt/0d1n/payloads/dir_brute.txt --threads 10 --timeout 3 --log logtest_brutedir --save_response\n"
YELLOW
"Notes:\n"
LAST
